...
class U extends f {
  ...
  addWindowEventHandler(t, i) {
    typeof window > "u" || (window.addEventListener(t, i), this.windowEventHandlers.push({ event: t, handler: i }));
  }
  destroy() {
    typeof window > "u" || this.windowEventHandlers.forEach(({ event: t, handler: i }) => {
...
class R extends f {
  ...
  up(t) {
    return this.pinching && t.type == "pointerup" && this.parent.input.touches.length <= 1 ? (this.active = !1, this.lastCenter = null, this.pinching = !1, this.moved = !1, this.parent.emit("pinch-end", this.parent), !0) : !1;
  }
  refresh() {
    this.active = !1, this.lastCenter = null, this.pinching = !1, this.moved = !1, this.parent.emit("pinch-end", this.parent), this.parent.input.clear();
  }
}
const j = {
  topLeft: !1,
...
class J extends f {
  ...
  handleKeyPresses(t) {
    typeof window > "u" || (window.addEventListener("keydown", (i) => {
...
class $ {
  ...
  up(r) {
    if (this.viewport.pause || !this.viewport.worldVisible)
      return;
    r.pointerType === "mouse" && (this.isMouseDown = !1), r.type === "pointerup" && this.remove(r.pointerId);
...
class tt {
  ...
  refresh(r) {
    var t;
    (t = this.plugins[r]) == null || t.refresh();
  }
}
const et = {
...
class ht extends P {
  ...
  resize(t = typeof window > "u" ? 0 : window.innerWidth, i = typeof window > "u" ? 0 : window.innerHeight, e, n) {
